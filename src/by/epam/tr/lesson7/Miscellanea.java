...
public class Miscellanea{
	...
	public static void main(String[] args){
		...
		Work w1 = new Drama("Drama1", "Author1", new Date(1981-1900,01,01));
		Work w2 = new Poem("Poem1", "Author2", new Date(1983-1900,01,01), 524);
		Work w3 = new Novel("Novel1", "Author3", new Date(1999-1900,01,01));
	...
	public void sortByDate(){
		Collections.sort(this.getListOfWorks(), new CompareByDate());
	}
	
	public void sortByAuthor(){
		Collections.sort(this.getListOfWorks(), new CompareByAuthor());
	}
	
	public void sortByWorkName(){
		Collections.sort(this.getListOfWorks(), new CompareByWorkName());
	}
