...
public class WarehouseView {
	public static void main(String[] args) {
		...
		Product p1 = new Product(1, "Item1", Categories.PROCESSORS, 123456, new Date(2017-1900,01,01), "processor 123 2.8 GHz dual core");
		Product p2 = new Product(2, "Item11", Categories.MONITORS, 111111, new Date(2015-1900,01,01), "Monitor DELL");
		Product p3 = new Product(3, "Item22", Categories.HDDS, 231232, new Date(2015-1900,01,01), "HDD 250 GB samsung");
		Product p4 = new Product(4, "Item3", Categories.NOTEBOOKS, 876543, new Date(2016-1900,01,01), "HP pavilion");
		Product p5 = new Product(5, "Item4", Categories.MONITORS, 123455, new Date(2016-1900,01,01), "HP 21 inches");
